...
2. **Меню точки** (стрелка или круглый значок):
   ...
   - фото: перетащите файлы на точку или нажмите «Добавить», порядок меняется перетаскиванием миниатюр,
     ...
     уменьшаются до 2400 px и хранятся в IndexedDB, поэтому переживают перезагрузку;
...
5. **Ролик**: титры, вид галереи (полароиды падают стопкой или слайды сменяют друг друга), секунд на фото,
